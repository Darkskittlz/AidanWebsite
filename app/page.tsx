    ...
    <>
      <div className="w-full grid justify-center grid-cols-1">
        <div key="listen" className="items-center flex flex-col smMobile:w-full">
          ...
          <iframe className="rounded-xl" src="https://open.spotify.com/embed/artist/2w251FvFhXVbtcc3iwmfXV?utm_source=generator" width="500px" height="384px" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </div>
      ...
      <div className="flex flex-col justify-center mt-12">
        ...
        {posts?.map(
          (post: {
            ...
            return (
              <div className="items-center pt-4 flex flex-col" key={post.title}>
                <div className="smMobile:w-3/4 desktop:w-1/3 justify-center backdrop-blur-lg p-4 border rounded-xl border-white">
                  <div>
                    <h1 className="text-3xl text-center text-red">{post.title}</h1>
                  </div>
